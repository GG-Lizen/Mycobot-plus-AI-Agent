...
def record():
   ...
   # 定义录音参数
    ...
    CHUNK = 1024              # 每个缓冲区的帧数
    RECORD_SECONDS = 7        # 录音时间
    OUTPUT_FILENAME = "temp/speech_record.wav"  # 输出文件名
...
appbuilder_api = config['DEFAULT']['APP_BUILDER_API']
os.environ["APPBUILDER_TOKEN"] = appbuilder_api
